...
{{--    <link rel="stylesheet" href="//code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">--}}
    ...
    <link rel="stylesheet" href="{{ asset('css/bootstrap-datepicker3-1.10.0.standalone.css') }}">
    ...
    <link href="{{ asset('DateTime-1.4.1/css/dataTables.dateTime.css') }}" rel="stylesheet" />{{--
    <link href="{{ asset('FixedColumns-4.2.2/css/fixedColumns.bootstrap5.css') }}" rel="stylesheet" />--}}
    <link href="{{ asset('FixedHeader-3.3.2/css/fixedHeader.bootstrap5.css') }}" rel="stylesheet" />{{--
    ...
    <link href="{{ asset('Scroller-2.1.1/css/scroller.bootstrap5.css') }}" rel="stylesheet" />{{--
    ...
    <link href="{{ asset('Select-1.6.2/css/select.bootstrap5.css') }}" rel="stylesheet" />{{--
...
<body class="font-sans antialiased">
    ...
    <script type="text/javascript" src="{{ asset('js/bootstrap-datepicker-1.10.0.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/papaparse-5.4.1.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('DataTables-1.13.4/js/dataTables.bootstrap5.js') }}"></script>{{--
    ...
    <script type="text/javascript" src="{{ asset('FixedHeader-3.3.2/js/dataTables.fixedHeader.js') }}"></script>
    <script type="text/javascript" src="{{ asset('FixedHeader-3.3.2/js/fixedHeader.bootstrap5.js') }}"></script>{{--
    ...
    <script type="text/javascript" src="{{ asset('Responsive-2.4.1/js/dataTables.responsive.js') }}"></script>
    <script type="text/javascript" src="{{ asset('Responsive-2.4.1/js/responsive.bootstrap5.js') }}"></script>{{--
    ...
    <script type="text/javascript" src="{{ asset('Scroller-2.1.1/js/dataTables.scroller.js') }}" defer></script>
    <script type="text/javascript" src="{{ asset('Scroller-2.1.1/js/scroller.bootstrap5.js') }}"></script>{{--
    ...
    <script type="text/javascript" src="{{ asset('Select-1.6.2/js/dataTables.select.js') }}"></script>
    <script type="text/javascript" src="{{ asset('Select-1.6.2/js/select.bootstrap5.js') }}"></script>{{--
